...
const text1_1 = '전문교양(20학점)을 이수하여야 함';
const text1_2 = '전공(전공필수 모두 포함하여 50학점)을 포함하여야 함. ';
const text1_3 = '총 140학점 이상(일반선택 포함) 이수하여야 함.';
const text2_1 =
...
const MyGraduateInfo10To15 = ({ obj }) => {
  ...
  return (
    <Collapse>
      ...
      {PanelListMaker(
        text3_1,
        gState['전문교양']['핵심교양필수영역']['qualify'],
        10,
        gState['전문교양']['핵심교양필수영역']['rest'],
        1
      )}
      {PanelListMaker(
        text3_2,
        gState['전문교양']['일반교양필수영역']['qualify'],

        11,
        gState['전문교양']['일반교양필수영역']['rest'],
        2
      )}
      {PanelMaker(
        text4_1,
